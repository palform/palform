        ...
        manager
            .alter_type(
                Type::alter()
                    ...
                    .add_value(AuditLogTargetResourceVariants::OrganisationAuthConfig),
            )
            .await?;
        manager
            .alter_type(
                Type::alter()
                    .name(AuditLogTargetResourceEnum)
                    .add_value(AuditLogTargetResourceVariants::OrganisationSubdomain),
            )
            .await?;
        manager
            .alter_type(
                Type::alter()
                    .name(AuditLogTargetResourceEnum)
                    .add_value(AuditLogTargetResourceVariants::Organisation),
            )
            .await
    }
