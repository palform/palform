...
pub enum Relation {
    ...
    AdminPublicKey,
    #[sea_orm(has_many = "super::admin_user_email_verification::Entity")]
    ...
    #[sea_orm(has_many = "super::social_auth_connection::Entity")]
...
impl Related<super::admin_user_email_verification::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::AdminUserEmailVerification.def()
    }
}
...
impl Related<super::social_auth_connection::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::SocialAuthConnection.def()
    }
}
