...
------------ | ------------- | ------------- | -------------
**info** | [**ConfigInfoInfo**](ConfigInfoInfo.md) |  | [default to undefined]
**text** | [**ConfigTextText**](ConfigTextText.md) |  | [default to undefined]
...
```typescript
import { APIQuestionConfiguration } from './api';

const instance: APIQuestionConfiguration = {
    info,
    text,
    choice,
    scale,
