...
#[patch(
    "/users/me/orgs/<org_id>/teams/<team_id>/members/<member_user_id>",
    data = "<new_role>"
)]
pub async fn handler(
    ...
    new_role: Json<OrganisationMemberRoleEnum>,
    ...
    OrganisationTeamsManager::change_member_role(db.inner(), team_id, member_user_id, new_role.0)
        .await
        .map_err(|e| e.to_internal_error())?;
