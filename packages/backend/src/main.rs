...
use rocket::{catchers, get, http::Method, launch, routes};
...
async fn rocket() -> _ {
    ...
    let mut r = rocket::build()
        ...
        .mount(
            ...
            routes![
                ...
                api::jobs::delete_old_submissions::handler,
                api::jobs::delete_old_auth_tokens::handler,
                api::jobs::delete_old_audit_logs::handler,
                api::jobs::delete_abandoned_emails::handler,
                api::jobs::submission_blocking::handler
            ],
        );
    ...
    let main_routes = openapi_get_routes_spec![
        ...
        api::questions::create::handler,
        api::questions::set::handler,
        api::questions::delete::handler,
        api::questions::list::handler,
        api::question_groups::list::handler,
        api::question_groups::create::handler,
        api::question_groups::set::handler,
        api::question_groups::delete::handler,
